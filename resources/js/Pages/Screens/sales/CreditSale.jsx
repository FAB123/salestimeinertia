...
// import { toHijri } from "../../helpers/HijriConverter";
...
function CreditSale() {
    ...
    return (
        <Stack>
            <Breadcrumb
                labelHead="CREDIT SALE"
                labelSub="Add/Edit Credit Sales"
            />
            <ToastContainer />
...
export default React.memo(CreditSale);
